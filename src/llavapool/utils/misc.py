...
def check_dependencies() -> None:
    ...
    if os.environ.get("DISABLE_VERSION_CHECK", "0").lower() in ["true", "1"]:
        ...
        require_version("transformers>=4.41.2,<=4.49.0", "To fix: pip install transformers>=4.41.2,<=4.49.0")
        require_version("datasets>=2.16.0,<=3.2.0", "To fix: pip install datasets>=2.16.0,<=3.2.0")
