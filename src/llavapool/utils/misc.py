...
def check_dependencies() -> None:
    ...
    if os.environ.get("DISABLE_VERSION_CHECK", "0").lower() in ["true", "1"]:
        ...
        require_version("transformers>=4.41.2,<=4.46.1", "To fix: pip install transformers>=4.41.2,<=4.45.2")
        require_version("datasets>=2.16.0,<=3.1.0", "To fix: pip install datasets>=2.16.0,<=2.21.0")
